...
HD_PWD='C:/Users/Administrator/Desktop/lab12/lab12.runs/vgaram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgaram.tcl
